...
b.index;this.updateSlides();this.$elem.trigger("onSlideChanged");!c&&this._setState();return b},next:function(){var a=this.slides[this.currentSlide];return a.steps.length?(a.doStep(),a):this.goTo(this.currentSlide+1)},toggleTransition:function(a){var c=this.transition;c!==a&&(null===a&&(a=!c),this.$elem.attr("data-transition",a?"On":"Off").trigger("transitionToggled",a),this.transition=a)},changeStatus:function(a){var c=this;d.each(c.status,function(b){c.status[b]=b===a});return c},play:function(){clearTimeout(this.playTimeOut);
var a=this.slides[this.currentSlide]||this.goTo(0),c=a.currentStep,b=d.proxy(function(){this.next();this.play()},this),e=a.timer;if(a.steps.length)e=c&&c.timer||this.options.slide.stepTimer;else if(this.currentSlide===this.slidesCount-1){if(!this.status.playing)return this.restart();b=d.proxy(function(){this.options.loopPlay?this.restart():this.stop()},this)}this.status.playing||(this.$elem.trigger("onPlay"),this.changeStatus("playing"),this.defaults.onPlay());this.playTimeOut=setTimeout(b,e);return this},
stop:function(){this.status.stopped||(clearTimeout(this.playTimeOut),this.$elem.trigger("onStop"),this.changeStatus("stopped"),this.defaults.onStopt());return this},pause:function(){this.status.paused||(clearTimeout(this.playTimeOut),this.$elem.trigger("onPause"),this.changeStatus("paused"),this.defaults.onPause());return this},restart:function(){this.goTo(0);this.play();this.$elem.trigger("onRestart");this.defaults.onRestart();return this},getSlide:function(a){var c=!1;"string"===d.type(a)&&d.each(this.slides,
function(b,d){if(d.id===a)return c=b,!1});d.isNumeric(a)?c=-1<a&&a<this.slidesCount&&a:a||(c=this.currentSlide);return d.isNumeric(c)?this.slides[c]:null},getSlideFromHash:function(){var a=this,c=location.hash.substr(1);if(""===c)return!1;var c=c.split("&"),b=!1;d.each(c,function(c,d){b=a.getSlide(d);return!b});return b},_setState:function(a){var c=this,b=c.slides[c.currentSlide];if(b){var b=b.id,e=history.state||{};a=a?"replaceState":"pushState";var f=location.hash.substr(1),h=!1,f=""==f?[]:f.split("&");
d.each(f,function(a,b){if(b.split("_")[0]==c.id)return h=a,!1});d.isNumeric(h)?f[h]=b:f.push(b);f=f.join("&");e[c.id]=b;if(history[a])history[a](e,"","#"+f);else window.location.hash=f;return c}},_onPopState:function(a){a=a.originalEvent||window.event;(a=(a=a.state&&a.state[this.id])?this.getSlide(a):this.getSlideFromHash())&&this.goTo(a.index,!0);return this},_keysHandler:function(a){var c=this.$elem;if(!/^(input|textarea)$/i.test(a.target.nodeName)&&!a.target.isContentEditable&&c.is(".focused"))switch(a.keyCode){case 32:this.status.playing?
this.pause():this.play();break;case 37:this.previous();break;case 39:this.next();break;case 38:this.scale(!1,10);break;case 40:this.scale(!1,-10);break;case 82:this.toggleTransition(null);break;case 84:this.changeTheme();break;case 122:a.preventDefault(),x(c[0])}},_setScaleHandler:function(){function a(){var a=b.width(),c=b.height()*g;c>a&&(c=a);k=c/h}var c=this,b=c.$elem,e=parseInt(d("html").css("font-size")),f=c.slides[0].$elem,h=parseInt(f.width()+2*e),g=h/(f.height()+2*e).toFixed(0),k=null,j=
null;a();return function(d,e){d||(a(),d=j);e&&(d+=parseInt(e));40>d?d=40:100<d&&(d=100);b.css("font-size",Math.round(d*k)+"%");j!==d&&(j=d,c.$elem.trigger("scaleChanged",j))}},_setThemeToggler:function(){var a=this.$elem,c=this.options,b=c.presentThemes,e=this.currentTheme||-1,f=c.initialTheme;return function(c){e=c?d.inArray(c,b):!d.isNumeric(e)||0>e?d.inArray(f,b):e+1;if(e>=b.length||0>e)e=0;a.attr("data-theme",b[e]);this.currentTheme=e;a.trigger("themeChanged",b[e])}},_addPrettify:function(){d("pre").addClass("prettyprint");
d.getScript("javascripts/prettify.js",function(){prettyPrint()})},_addFontStyle:function(){d("body").append(d("<link/>",{rel:"stylesheet",type:"text/css",href:"http://fonts.googleapis.com/css?family=Open+Sans:regular,semibold,italic,italicsemibold|Droid+Sans+Mono"}))}};var B=function(a,c){var b=this,e=d(a);e.append('<div class="ord"><span class="handler"></span></div> ');e.addClass("hideable");b.$elem=e;b.$ord=e.find(".ord");b.$handler=e.find(".handler");b.elemWidth=parseInt(e.width());b.ordWidth=
parseInt(b.$ord.width());b.handlerWidth=parseInt(b.$handler.width());b.min=parseInt(e.attr("min"));b.max=parseInt(e.attr("max"));b.step=b.ordWidth/(b.max-b.min);b.onChange=c;e.on(b.setDragHandler()).on(l(function(a){a&&b.setValue(b._value-10*a)})).on("touchstart",j);b.setValue(parseInt(e.attr("value")));return b};B.prototype={setDragHandler:function(){function a(a){a.preventDefault();a=((parseInt(a.pageX)-e)*f+b.min).toFixed(1);95<a&&110>a&&(a=100);b.setValue(a)}function c(){d(window).off("mousemove touchmove",
a);b.$elem.addClass("hideable")}var b=this,e=parseInt(b.$ord.offset().left),f=(b.max-b.min)/b.ordWidth;return{mousedown:function(f){f.preventDefault();e=parseInt(b.$ord.offset().left);b.$elem.removeClass("hideable");a(f);d(window).on({mousemove:a,mouseup:c,touchmove:j,touchend:j})}}},setValue:function(a){a=Math.round(parseInt(a));a>this.max?a=this.max:a<this.min&&(a=this.min);if(a!==this._value)return this.value=a,this.update(),this.onChange&&this.onChange(a),this},update:function(){var a=Math.round(this.step*
(this.value-this.min));0>a?a=0:a>this.ordWidth&&(a=this.ordWidth);this.$handler.css("left",a-this.handlerWidth/2);return a}};var v=function(a,c,b,e){var f=this;a=d(a);var g=d("<div/>",{"class":"selector"}),j=d("<ul/>",{"class":"list",html:d.map(b,function(a){return d("<li/>",{text:a})})});g.attr("data-description",c).on("mousedown",function(){j.slideToggle()});j.on("mousedown","li",function(){f.setValue(d(this).text())});f.$selector=g;f.$list=j;f.$items=j.children("li");f.callback=e||d.noop;f.value=
null;a.append(g,j);return f};v.prototype={setValue:function(a){this.$list.slideUp();this.value!==a&&(this.$selector.text(a),this.value=a,this.onChange())},onChange:function(){var a=this;a.callback(a.value);d.each(a.$items,function(c,b){b=d(b);b.toggleClass("active",b.text()==a.value)})}};d.fn.makePresent=function(a){this.each(function(c,b){new n(b,a)})}}(document,jQuery);$(function(){$(".presentation").makePresent()});
